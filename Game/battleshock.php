...
if(isset($_POST['shocked'])){
  ...
  $sql = "SELECT turn.ID as turn FROM battle, round, turn, phase_type, player
        WHERE round.FK_Battle = battle.ID AND round.FK_Turn = turn.ID AND turn.FK_Phase = phase_type.ID AND turn.FK_Player = player.ID AND battle.ID = ".$battleID." ORDER BY round.FK_Turn DESC LIMIT 1";
  
  $resultRound = mysql_query($sql);
  $turn = mysql_result($resultRound,0);



  $sql="SELECT Slain as slain from death_log WHERE FK_Battle =".$battleID." AND FK_Turn =".$turn;

  $result = mysql_query($sql);
  $result = mysql_fetch_array($result);
  $slain = array_values($result);

  $sql="SELECT FK_Target as target from death_log WHERE FK_Battle =".$battleID." AND FK_Turn =".$turn;

  $result = mysql_query($sql);
  $result = mysql_fetch_array($result);
  $target = array_values($result);
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">ConnecTables</a>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Battleshock</li>
      </ol>
      <div class="row">
        <div class="col-12">
...
<form method="POST">
        ...
        <button type="submit" class="btn btn-primary btn-block" name="shocked" onmousedown="dice.play()">Shock The Lines!</button>
